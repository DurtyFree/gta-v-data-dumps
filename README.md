...
- **Particle Effects** (particleEffectsCompact.json) **294** particle effect dictionaries & **2394** particle effects in total (Usable with START PARTICLE FX natives)
- **(Ped) Scenarios** (scenariosCompact.json) **239** scenarios in total (Usable with scenario related natives)
- **Animations** (animDictsCompact.json) **16366** animation dictionaries & **167409** animations in total (Usable with TASK PLAY ANIM native)
...
- **Vehicle Mod Kits & Mods** (vehicleModKits.json) **409** vehicle mod kit infos with **43749** mods in total (Usable with SET_VEHICLE_MOD_KIT,SET_VEHICLE_LIVERY & SET_VEHICLE_MOD natives)
...
- **Ped Component Variations** (pedComponentVariations.json) **24513** component variations & **3501** ped props from a total of **74** ped component variation collections (Usable with COMPONENT VARIATION & PED PROP natives)
