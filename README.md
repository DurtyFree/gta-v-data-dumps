...
- **Script Audio Bank names** ([scriptAudioBankNames.json](scriptAudioBankNames.json)) **588** script audio bank names in total (Usable with SCRIPT_AUDIO_BANK natives)
...
- **Seats** (Benches, Chairs etc.) ([worldSeats.json](objectslocations/worldSeats.json)) **8009** in total
